...
function print_tracking() {
  ...
  cryptoList.forEach((item) => {
    ...
    todoItem.innerHTML = `
                    ...
                    <div class="crypto_img_box">
                      <img class="crypto_img" src="${item.image}">
                    </div>
                    ...
                    <div class="crypto_price_perc" style="color:${appColor}"><b><span>${parseFloat(
    ...
    todoItem.addEventListener("click", function () {
      ...
      $("#crypto_body").html(`
              ...
              <div class="spanSpecialChild"><span>Daily Low: ${
                item.low_24h
              }€</span><span>Daily High: ${item.high_24h}€ </span></div>
              <iframe src="https://bit2me.com/widget/chart/v1?currency=${
                item.symbol
              }&fiat=EUR" style="display:block;width:100%;height:400px;margin:0 auto;" frameborder="0"></iframe>`);
    });
